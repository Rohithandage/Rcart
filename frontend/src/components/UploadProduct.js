...
<label htmlFor='link' className='mt-3'> Enter URL</label>
        <input type='url'
         id='link'
...
<div>
 ...
 <img src={el} alt={el}
                        ...
                        <div className='absolute bottom-0 right-0 text-white bg-red-600 rounded-full hidden group-hover:block cursor-pointer' onClick={()=>handleDeleteProductImage(index)}>
                        <AiFillDelete/>
                        </div>
                        </div>
